...
/**
 * TOP API: aliexpress.affiliate.order.get response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class AliexpressAffiliateOrderGetResponse extends TaobaoResponse {

	private static final long serialVersionUID = 1231613311778236622L;
...
public static class Order extends TaobaoObject {
	...
	private static final long serialVersionUID = 3451548138336995763L;
	...
	/**
		 ...
		 * 自定义参数(JSON格式）
		 */
		@JsonProperty("customer_parameters")
...
public static class TrafficOrderResultDto extends TaobaoObject {
	...
	private static final long serialVersionUID = 6182596666879228919L;
...
public static class ResponseDto extends TaobaoObject {
	...
	private static final long serialVersionUID = 1796814811894815523L;
